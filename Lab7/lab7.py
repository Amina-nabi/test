...
if __name__ == "__main__":
    tech_manager = TechManager(name='София', employee_id=1, department='ИТ', specialization='Программист')
    manager = Manager(name='Виктория', employee_id=2, department='Маркетинг')
    technician = Technician(name='Виктор', employee_id=3, specialization='Электрик')
